...
const Articles = () => {
    return (
            ...
            <div className="article-container text-center">
                ...
                <img src={chatbot} alt="img chatbot" width="40%"></img></MDBAnimation>
                ...
                <MDBAnimation reveal type="fadeIn" duration="2s">
                    <img src={branding} alt="img branding" width="40%"></img></MDBAnimation>
                ...
                <MDBAnimation reveal type="slideInRight" duration="2s">
                    <img src={web} alt="img web" width="40%"></img></MDBAnimation>
