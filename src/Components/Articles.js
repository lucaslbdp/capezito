...
const Articles = () => {
    return (
            ...
            <div className="article-container text-center gris">
                ...
                <img src={chatbot} alt="img chatbot" className="imgs-chat"></img></MDBAnimation>
                ...
                <MDBAnimation reveal type="fadeIn" duration="2s">
                    <img src={branding} alt="img branding" className="imgs-chat"></img></MDBAnimation>
                ...
                <MDBAnimation reveal type="slideInRight" duration="2s">
                    <img src={web} alt="img web" className="imgs-chat"></img></MDBAnimation>
